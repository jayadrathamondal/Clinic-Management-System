      ...
      <fieldset>
        ...
        <div>
          ...
          <div class="form-group">
            <div class="col-md-12"><input type="text" name='drug_name_en' id="drug_name_en" value="<?php echo $this->input->post('drug_name_en');?>" class='form-control' placeholder='Drug Name' title='Drug Name' required autofocus /></div>
          </div>
          <div class="form-group">
