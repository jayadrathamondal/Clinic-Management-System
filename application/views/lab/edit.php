      ...
      <fieldset>
        ...
        <div id="test_info">
          ...
          <div class="form-group">
              <div class="col-md-12"><input type="text" name='test_name_en' id="test_name_en" value="<?php echo set_value('test_name_en', $test->test_name_en);?>" class='form-control' placeholder='Test Name' title='Test Name' required autofocus /></div>
          </div>
          <div class="form-group">
