...
CREATE TABLE IF NOT EXISTS `patients` (
  ...
  `id_type` enum('','PAN Card','Voter ID','Passport','Aadhar','Driving License') DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `userdata` (
  ...
  `id_type` enum('','PAN Card','Voter ID','Passport','Aadhar','Driving License') DEFAULT 'Aadhar',
  `birth_date`int(11) NULL DEFAULT NULL,
  `create_date` int(11) NOT NULL,
  `picture` text,
  `memo` text,
